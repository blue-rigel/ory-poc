...
// shared first-party session cookie. No code or state is shared with App A —
...
export default function SsoAppB() {
  ...
  return (
    <div className="w-1/2 m-auto mt-16">
      <Card>
        <CardHeader>
          <CardTitle>App B</CardTitle>
          <CardDescription>
            Reads the shared Ory session cookie independently — no shared code with App A.
          </CardDescription>
        </CardHeader>
        ...
        <CardFooter className="gap-2">
          ...
          <Button asChild variant="outline">
            <Link href="/sso/app-a">Go to App A</Link>
          </Button>
        </CardFooter>
      </Card>
    </div>
